...
The goal of this challenge was to build a website that was linked to a database, stores the database information, and displays information based on the users input. The challenge used an index.html file linked to an app.js file. The html file contained the code for the display of the webpage and the app.js file contained the code for the functionality. 
